...
export function meta(_: Route.MetaArgs) {
  return [
    { title: "Intastellar Consents changelog · inta.dev" },
    {
      name: "description",
      content:
        "GitHub releases and version tags for Intastellar Consents (cookie / consent management).",
    },
  ];
}
...
export default function ConsentsChangelogPage() {
  const { entries, repo, error } = useLoaderData<typeof loader>();

  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">
        Intastellar Consents — Changelog
      </h1>
