...
Wis **uw** sessie en volg **SDK / Intastellar**-richtlijnen voor uitloggen. Als een **end-session**-URL beschikbaar is, zorgt redirecten daarheen voor wissen van IdP SSO-cookies op het identity-domein. Zie [Afmelden, fouten en troubleshooting](/docs/accounts-sign-in/web/logout-and-errors).
