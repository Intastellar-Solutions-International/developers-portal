...
Gebruik bij voorkeur Intastellars afmeld-API zodat de cookie **`inta_account`** zoals in productie wordt verwijderd:

```javascript
Intastellar.accounts.signout();
// Daarna doorverwijzen of herladen, bijv.:
// window.location.href = "/";
```

Als de API niet beschikbaar is (script niet geladen), kunt u het cookie handmatig wissen op uw parent-domein — **naam** en **domein/pad** moeten overeenkomen met uw integratie (zie SDK-readme):
