...
| `experiment` | object | Configuração opcional de testes A/B (global ou por canal) |
...
Para `window.INTA.experiment`, segmentação por canal e exemplos prontos para uso, veja **[Experimentos](/docs/cookie-banner/javascript/experiments)**.
