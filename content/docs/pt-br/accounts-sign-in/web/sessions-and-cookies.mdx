...
Limpe **sua** sessão e siga as orientações do **SDK / Intastellar** para sair. Se houver URL de **end-session**, redirecionar para lá limpa cookies SSO no domínio de identidade. Veja [Logout, erros e solução de problemas](/docs/accounts-sign-in/web/logout-and-errors).
