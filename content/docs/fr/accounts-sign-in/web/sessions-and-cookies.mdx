...
Effacez **votre** session et suivez les indications **SDK / Intastellar** pour la sortie. Si une URL **end-session** est disponible, y rediriger efface les cookies SSO IdP sur le domaine d’identité. Voir [Déconnexion, erreurs et dépannage](/docs/accounts-sign-in/web/logout-and-errors).
