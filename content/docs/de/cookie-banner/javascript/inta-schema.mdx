...
| `experiment` | object | Optionale A/B-Test-Konfiguration (global oder kanalspezifisch) |
...
Details zu `window.INTA.experiment`, Kanal-Targeting und Codebeispiele finden Sie unter **[Experimente](/docs/cookie-banner/javascript/experiments)**.
