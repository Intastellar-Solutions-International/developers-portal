...
On **paid / platform** tiers, consent decisions can be **logged** for audit and reporting (see product comparison on the public site). The free banner still enforces UI and blocking; retention and export features depend on your plan.
