...
- **JavaScript without React:** [JavaScript without React](/docs/accounts-sign-in/web/javascript-without-react) (migrated from the former developers-site `js-docs` page).
...
For sites **without React**, follow **[JavaScript without React](/docs/accounts-sign-in/web/javascript-without-react)** — popup flow, required `postMessage` ack, and honest notes on the npm package’s React peers.
