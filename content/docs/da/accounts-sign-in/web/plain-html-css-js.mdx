...
Brug helst Intastellars log-ud-API, så cookien **`inta_account`** fjernes som i produktion:

```javascript
Intastellar.accounts.signout();
// Omdiriger eller genindlæs derefter efter behov, fx:
// window.location.href = "/";
```

Hvis API’et ikke kan kaldes (fx script ikke indlæst), kan du manuelt slette cookien på dit parent-domæne — **navn** og **domæne/sti** skal matche din integration (se SDK-readme):
