...
| `experiment` | object | Valgfri A/B-testkonfiguration (global eller kanalspecifik) |
...
Se **[Eksperimenter](/docs/cookie-banner/javascript/experiments)** for detaljer om `window.INTA.experiment`, kanalmålretning og eksempler.
